...
Producto::Producto (string _nombre, float _costo, float _precio) {
    nombre = _nombre;
    costo = _costo;
    precio = _precio;
...
void GuardarTodo(Producto P1[3], const string &filename) {
...
void CargarTodo(Producto P1[3], const string &filename) {
...
int main() {
	...
	CargarTodo(P1, "save.txt");

    system("clear");
    Menu(P1);

	GuardarTodo(P1, "save.txt");
    return 0;
}
